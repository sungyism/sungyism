...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->conf_arg = gengetopt_strdup ("/opt/ganglia/etc/gmond.conf");
      ...
      switch (c)
        ...
        case 'c':	/* Location of gmond configuration file.  */
          ...
          if (update_arg( (void *)&(args_info->conf_arg), 
              ...
              &(local_args_info.conf_given), optarg, 0, "/opt/ganglia/etc/gmond.conf", ARG_STRING,
