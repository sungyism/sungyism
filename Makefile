...
pkgdatadir = $(datadir)/ganglia
pkgincludedir = $(includedir)/ganglia
pkglibdir = $(libdir)/ganglia
pkglibexecdir = $(libexecdir)/ganglia
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/ganglia.spec.in $(top_srcdir)/configure \
	$(top_srcdir)/ganglia.inc \
	$(top_srcdir)/gmetad-python/Gmetad/gmetad_config.py.in \
	$(top_srcdir)/gmetad-python/gmetad-python.conf.in \
	$(top_srcdir)/gmetad-python/plugins/rrd_plugin.py.in \
	$(top_srcdir)/gmetad-python/setup.py.in \
	$(top_srcdir)/scripts/fixconfig.in AUTHORS COPYING ChangeLog \
...
CONFIG_CLEAN_FILES = scripts/fixconfig ganglia.spec \
	gmetad-python/setup.py gmetad-python/Gmetad/gmetad_config.py \
...
ACLOCAL = ${SHELL} /home/sungyism/downloads/ganglia-3.4.0/build/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/sungyism/downloads/ganglia-3.4.0/build/missing --run tar
APR_CONFIG = /usr/bin/apr-1-config
APR_INCLUDES = -D_REENTRANT -D_GNU_SOURCE -D_LARGEFILE64_SOURCE -I/usr/include/apr-1.0    -I/usr/include/apr-1.0 
AR = ar
AUTOCONF = ${SHELL} /home/sungyism/downloads/ganglia-3.4.0/build/missing --run autoconf
AUTOHEADER = ${SHELL} /home/sungyism/downloads/ganglia-3.4.0/build/missing --run autoheader
AUTOMAKE = ${SHELL} /home/sungyism/downloads/ganglia-3.4.0/build/missing --run automake-1.11
AWK = mawk
CC = gcc -std=gnu99
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -fno-strict-aliasing -Wall -D_REENTRANT
CPP = gcc -std=gnu99 -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
LT_RELEASE = 3.4.0
LT_REVISION = 0
MAKEINFO = ${SHELL} /home/sungyism/downloads/ganglia-3.4.0/build/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
SET_MAKE = 
SHELL = /bin/bash
STATIC_USER_MODULES = yes
STRIP = strip
VERSION = 3.4.0
abs_builddir = /home/sungyism/downloads/ganglia-3.4.0
abs_srcdir = /home/sungyism/downloads/ganglia-3.4.0
abs_top_builddir = /home/sungyism/downloads/ganglia-3.4.0
abs_top_srcdir = /home/sungyism/downloads/ganglia-3.4.0
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/sungyism/downloads/ganglia-3.4.0/build/install-sh
libdir = /opt/ganglia/lib
...
mkdir_p = /bin/mkdir -p
modpathstart = 
moduledir = /opt/ganglia/lib/ganglia
...
INCLUDES = -D_REENTRANT -D_GNU_SOURCE -D_LARGEFILE64_SOURCE -I/usr/include/apr-1.0    -I/usr/include/apr-1.0 
...
am--refresh:
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/ganglia.inc $(am__configure_deps)
	@for dep in $?; do \
...
scripts/fixconfig: $(top_builddir)/config.status $(top_srcdir)/scripts/fixconfig.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
ganglia.spec: $(top_builddir)/config.status $(srcdir)/ganglia.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
gmetad-python/setup.py: $(top_builddir)/config.status $(top_srcdir)/gmetad-python/setup.py.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
gmetad-python/Gmetad/gmetad_config.py: $(top_builddir)/config.status $(top_srcdir)/gmetad-python/Gmetad/gmetad_config.py.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
gmetad-python/gmetad-python.conf: $(top_builddir)/config.status $(top_srcdir)/gmetad-python/gmetad-python.conf.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
gmetad-python/plugins/rrd_plugin.py: $(top_builddir)/config.status $(top_srcdir)/gmetad-python/plugins/rrd_plugin.py.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
ganglia.sub: ganglia.pod
	sed -e 's/GANGLIA_VERSION/3.4.0/' < $(srcdir)/ganglia.pod > ganglia.sub

man_create: ganglia.sub
	pod2man --section 3 --center "ganglia" --release "3.4.0" --date "`date`" --name ganglia ganglia.sub ganglia.man
